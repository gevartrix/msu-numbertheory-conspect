...
%% [fancyhdr,lastpage] Sets up the header and footer parts of pages' layout
% Clears header and footer completely
\fancyhf{}
% Puts the current subsection number and name on the left side of the header
% The `\leftmark` command outputs the number and name of the current section in the `article` document class
\lhead{
    \sc\rightmark
}
