...
- [x] Алгебраические и трансцендентые числа
...
- **[папка sections](sections/)**: файлы с самой вёрсткой конспекта
  ...
  * **[папка supplementary](sections/supplementary)**: разбитые по разделам файлы, содержащие ссылки на дополнительные материалы (используя окружение `thebibliography`)
